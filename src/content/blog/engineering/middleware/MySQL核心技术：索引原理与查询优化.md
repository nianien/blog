...
> 关于 B+Tree、B-Tree、LSM-Tree 等存储引擎数据结构的理论细节，参见[《存储引擎核心数据结构：B-Tree 家族与 LSM-Tree 的设计权衡》](/engineering/algorithm/存储引擎核心数据结构：B-Tree家族与LSM-Tree的设计权衡)。本文聚焦 MySQL 层面的索引使用和优化。
...
>
> - **索引原理与查询优化**
> - [事务与锁机制](/blog/engineering/middleware/MySQL核心技术：事务与锁机制)
