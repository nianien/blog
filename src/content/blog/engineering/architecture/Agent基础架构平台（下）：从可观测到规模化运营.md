...
> [上篇](/engineering/architecture/Agent基础架构平台（上）：从全景架构到核心层设计)讲了 Agent 在什么上面跑，这篇讲怎么让它跑得稳、看得清、管得住、长得大。
...
>
> **上篇**：[《Agent 基础架构平台（上）：从全景架构到核心层设计》](/engineering/architecture/Agent基础架构平台（上）：从全景架构到核心层设计)
