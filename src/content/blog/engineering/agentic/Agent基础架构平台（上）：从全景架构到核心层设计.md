...
> Agent 基础架构平台不是在白纸上画图，而是在 LLM 的非确定性之上，用工程化的手段重建确定性。这是贯穿接入、调度、运行时、能力四层设计的核心命题。
>
> 但画好架构图只是故事的一半。一个平台真正能在生产环境中跑起来，还需要回答"出了问题怎么看、规模上来怎么扛、安全合规怎么管"这些问题。
>
> **下篇**：[《Agent 基础架构平台（下）：从可观测到规模化运营》](/blog/engineering/agentic/Agent基础架构平台（下）：从可观测到规模化运营)
