...
>
> - 上一篇：[01 | 从LLM到Agent：Agentic系统的知识地图](/engineering/agentic/01-从LLM到Agent：Agentic系统的知识地图)
> - 下一篇：[03 | Agent、Workflow与Automation：选对抽象才是关键](/engineering/agentic/03-Agent、Workflow与Automation：选对抽象才是关键)
