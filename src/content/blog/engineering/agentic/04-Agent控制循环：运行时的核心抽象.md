...
![LLM vs Agent](/images/blog/agentic-04/llm-vs-agent.svg)
...
![Agent 控制循环状态机](/images/blog/agentic-04/control-loop-state-machine.svg)
...
![输入归一化](/images/blog/agentic-04/input-normalization.svg)
...
![Context Window 组成](/images/blog/agentic-04/context-window.svg)
...
| 模式 | 执行流程 | 延迟 |
|------|---------|------|
| **同步执行** | think → tool_1 → wait → tool_2 → wait → reflect | T1 + T2 |
| **异步执行** | think → tool_1 / tool_2 并行 → reflect | max(T1, T2) |
...
![ReAct Loop](/images/blog/agentic-04/react-loop.svg)
...
![Plan-then-Execute Loop](/images/blog/agentic-04/plan-then-execute.svg)
...
![ReAct vs Plan-then-Execute 权衡](/images/blog/agentic-04/react-vs-plan-tradeoff.svg)
...
![状态存储方案对比](/images/blog/agentic-04/state-storage-options.svg)
