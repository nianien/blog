---
title: "关于分布式事务、两阶段提交协议、三阶提交协议"
pubDate: "2024-03-21"
description: "--- description: >-   随着大型网站的各种高并发访问、海量数据处理等场景越来越多，如何实现网站的高可用、易伸缩、可扩展、安全等目标就显得越来越重要。为了解决这样一系列问题，大型网站的架构也在不断发展。提高大型网站的高可用架构，不得不提的就是分布式。在分布式一致性一文中主要介绍了分..."
tags: ["系统架构"]
---
...
![1](/public/images/books/image_3_4.png)

<div data-full-width="true">

![1](/public/images/books/image_3.png)
